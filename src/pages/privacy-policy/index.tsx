...
const PrivacyPolicy: FC<PrivacyPolicyProps> = ({ pageData }) => {
  const language: string | undefined = Cookies.get("language");

  return (
    <div>
      <NextSeo
        title={localeString(language, "publicLibraryPrivacyPolicy")}
        description={pageData?.description}
        openGraph={{
          title: "Public Library: Privacy Policy",
          description: pageData?.description,
          images: [
            {
              url: "/library_logo.svg",
              alt: "Public Library: Privacy Policy",
            },
          ],
        }}
      />
