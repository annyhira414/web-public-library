...
const Gallery: FC<IGalleryPage> = ({
  ...
  useEffect(() => {
    ...
    router.push(
      `/gallery/photo-gallery?page=${page}&startDate=${startDate}&endDate=${endDate}&search_term=${keywords}`,
      undefined,
      {
        shallow: false,
      }
  ...
  const handlePageChange = (pageNumber: number) => {
    ...
    router.push(
      `/gallery/photo-gallery?page=${pageNumber}&startDate=${startDate}&endDate=${endDate}&search_term=${keywords}`,
      undefined,
      {
        shallow: false,
      }
  ...
  return (
    <>
      <NextSeo
        title={`${localeString(language, "photoGalleryTitle")}`}
        description="The public libraries' all notice has been published here"
        openGraph={{
          title: "Photo Gallery",
          description: "This is a Photo Gallery",
          images: [
            {
              url: `${process.env.NEXT_PUBLIC_BASE_URL}/gallery/photo-gallery`,
              alt: "Photo Gallery",
            },
          ],
        }}
      ...
      <div className="pl-content-container pb-6">
        ...
        <GalleryCard galleryData={galleryData} language={language} />
