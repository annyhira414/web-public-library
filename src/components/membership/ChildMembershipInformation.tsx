...
interface IChildMembershipInformation {
  proPic?: File;
  nidFrontImage?: File;
  nidBackImage?: File;
}

export const ChildMembershipInformation: FC<
  IChildMembershipInformation
> = () => {
      ...
      <Row className="bg-white py-6 px-16 border-t-4 border-library-primary rounded-b-lg mt-5">
        ...
        >
          <div className="profilepic-upload">
            <label htmlFor="profilepicUpload" className="text-sm text-gray-700">
